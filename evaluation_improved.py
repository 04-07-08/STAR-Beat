# -*- coding: utf-8 -*-
"""
DeepBeat 改进版评价脚本 (Complete Refined Version)
1. 对齐创新版预处理：Detrend + Z-Score
2. 手动接管阈值判定，解决阈值修改无效问题
3. 导出 ROC 曲线数据 (TPR/FPR)
4. 导出每个样本的原始预测概率与真实标签
"""
...
#   路径配置
# =======================
MODEL_PATH = "./deepbeat_lite_improved_best.h5"
DATA_PATH = "D:/AFdataset/test.npz"
#EXPORT_EXCEL_PATH = "./evaluation_results_detail.xlsx" # 导出的 Excel 总表路径
